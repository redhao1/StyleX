...
function Checkout (props) {
    ...
    async function submitForm () {
        ...
        if (isBillingFormEmpty || isPaymentFormEmpty) {
            Swal.fire({
                title: 'Oops!',
            ...
            const result = await axios.post("/rentProduct", {billingForm: billingForm, paymentForm: paymentForm, totalPrice: product.price, productId: id, productSKU: sku});
    ...
    async function getItems() {
        const response = await axios.get("/getProduct", { params: { productId: id, productSKU: sku } });
