...
function Item (props) {
    ...
    return (
        <tr>
            <td className="product-remove text-center" valign="middle"><a onClick={() => props.deleteWishlistItem(props.data.productId, props.data.sku)}><i className="icon icon anm anm-times-l"></i></a></td>
            ...
            <td className="product-price text-center"><span className="amount">${props.data.price}</span></td>
            ...
            <td className="product-subtotal text-center"><button type="button" className="btn btn-small" onClick={addToCart} disabled={!cart} style={!cart ? {backgroundColor: "white", color: "pink", borderColor: "pink"} : null}>{buttonText}</button></td>
        </tr>
    );
}
