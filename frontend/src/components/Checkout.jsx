...
function Checkout (props) {
    ...
    const [shippingPrice, setShippingPrice] = useState(49);
    ...
    async function submitForm () {
        ...
        if (isBillingFormEmpty || isPaymentFormEmpty) {
            ...
            const result = await axios.post("/placeOrder", {billingForm: billingForm, paymentForm: paymentForm, totalPrice: totalPrice});
                        ...
                        <div className="your-order">
                            ...
                            <div className="table-responsive-sm order-table"> 
                                <table className="bg-white table table-bordered table-hover text-center">
                                    ...
                                    <tbody>
                                        {products.map((row) => (
                                            <Item data={row} pageRefresh={getItems} />
                                        ))}
                                    </tbody>
