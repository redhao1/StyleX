...
function ShopPage (props) {
    ...
    useEffect(() => {
        async function getProductsByCategory() {
            try {
                const response = await axios.get("/Product/getProductsByCategory", {params: {id: id}});
    ...
    <Banner title={`${title != "" ? `Shop ${title.gender}'s ${title.category}` : `No Products Available`}`}></Banner>
