...
function ShopByGender (props) {
    ...
    useEffect(() => {
        async function getProductsByCategory() {
            try {
                const response = await axios.get("/Product/getProductsByGender", {params: {id: id}});
    ...
    <Banner title={`${title != "" ? `Shop for ${title}` : `No Products Available`}`}></Banner>
